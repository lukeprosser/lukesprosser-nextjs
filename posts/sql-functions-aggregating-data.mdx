...
<InfoText>
  If you haven’t already gone through the previous posts in this series, check out <Link href='/posts/sql-functions-strings'><a>SQL Functions: Working with Strings</a></Link>
</InfoText>
