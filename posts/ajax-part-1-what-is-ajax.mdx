...
![JavaScript common request and response](/images/posts/ajax-part-1-what-is-ajax/common-request-response.png 'JavaScript common request and response')
...
![AJAX engine request and response](/images/posts/ajax-part-1-what-is-ajax/ajax-request-response.png 'AJAX engine request and response')
...
- [jQuery](https://jquery.com/) (third party DOM manipulation library)
- [Axios](https://axios-http.com/) (third party)
- [Superagent](https://visionmedia.github.io/superagent/) (third party)
- [Prototype](http://prototypejs.org/learn/introduction-to-ajax) (third party)
- [Node HTTP](https://nodejs.org/api/http.html) (part of Node)
...
In <Link href="/posts/ajax-part-2-loading-plain-text-data"><a>AJAX Part 2: Loading Plain Text Data</a></Link>, we'll dive deeper under the hood by building a demo application to load text data into a UI. This will provide a more practical understanding by allowing you to write some code!
